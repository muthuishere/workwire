...
(`~/.config/workwire/sessions/<name>/inbox.ndjson`). The session — the intelligence, not
workwire — answers from its own live context and stamps the concrete question id:
